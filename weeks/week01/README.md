...
[https://www.senecacollege.ca/cgi-bin/subject?s1=BTI225](https://www.senecacollege.ca/cgi-bin/subject?s1=BTI225)
...
* query string: `?s1=BTI225` - additional parameters sent to the server as part of the URL, of the form `name=value`
...
```bash
$ curl https://www.senecacollege.ca/cgi-bin/subject?s1=BTI225
...
```bash
$ curl --include https://www.senecacollege.ca/cgi-bin/subject\?s1\=BTI225
HTTP/1.1 200 OK
